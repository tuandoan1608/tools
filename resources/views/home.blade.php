              ...
              <div class="col-md-7 ">
                    ...
                    <div class="col-md-6 ">
                      <div class="input-group mb-3">
                          <a type="button"  id="email" name="email" value="xxxx"> <span class="input-group-text" id="basic-addon1"> <img src="https://img.icons8.com/color/48/000000/email-sign.png"/></span></a>
                      </div>
                      <div class="input-group mb-3">
                        <a type="button"  id="email" name="email" value="xxxx"> <span class="input-group-text" id="basic-addon1"> <img src="https://img.icons8.com/color/48/000000/email-sign.png"/></span></a>
                    </div>
